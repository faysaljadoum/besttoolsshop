          ...
          <div dir="rtl" className="relative bg-white rounded-2xl shadow-2xl w-full max-w-lg p-6 md:p-8 animate-popup">
            ...
            {status ? (
              ...
              <form action={handleSubmit} className="space-y-4 text-right">
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1">الاسم <span className="text-red-500">*</span></label>
                  <input name="name" required type="text" className="w-full p-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none text-right bg-gray-50" placeholder="الاسم" />
                </div>
                ...
                <div>
                  <label className="block text-sm font-bold text-gray-700 mb-1">عنوان التوصيل <span className="text-red-500">*</span></label>
